...
export const dayCardBlocks: DayBlock[] = [
  {
    ...
    accent: 'amber',
    tasks: [
      { id: 't1', title: 'Подъём до 7:00', time: '07:00', done: false, pillarTags: ['acceptance'], weight: 1 },
      { id: 't2', title: 'Полное дыхание — 10 циклов', time: '07:05', done: false, pillarTags: ['breathing', 'smile'], weight: 2, autoSource: { type: 'breathing', refId: 'b1', minMinutes: 2 } },
      { id: 't3', title: 'Душ / осознанное дыхание', time: '07:15', done: false, pillarTags: ['breathing', 'acceptance'], weight: 1 },
      { id: 't4', title: 'Умыть лицо холодной водой — 1 мин', time: '07:30', done: false, pillarTags: ['acceptance', 'breathing'], weight: 1 },
      { id: 't5', title: 'Чистить зубы — 20 вдохов каждой рукой', time: '07:35', done: false, pillarTags: ['breathing'], weight: 1 },
      { id: 't6', title: 'Стакан воды с лимоном — 5–8 мин осознанно', time: '07:40', done: false, pillarTags: ['nutrition', 'silence'], weight: 1 },
      { id: 't7', title: 'Дыхательный комплекс (полное · ритмическое · очищающее)', time: '08:00', done: false, pillarTags: ['breathing'], weight: 2, autoSource: { type: 'breathing', refId: 'b4', minMinutes: 3 } },
      { id: 't8', title: 'Музыка / танец / зарядка — 5 мин', time: '08:20', done: false, pillarTags: ['smile'], weight: 1 },
    ],
  },
  {
    id: 'day',
    ...
    accent: 'none',
    tasks: [
      { id: 't9', title: 'Прогулка / осознанное дыхание — 20 мин', done: false, pillarTags: ['breathing', 'smile'], weight: 2 },
      { id: 't10', title: 'Последний приём пищи до 18–19 часов', time: '18:30', done: false, pillarTags: ['nutrition', 'acceptance'], weight: 1 },
    ],
  },
  {
    id: 'evening',
    ...
    accent: 'violet',
    tasks: [
      { id: 't11', title: 'Дыхательные упражнения (вечер)', time: '19:30', done: false, pillarTags: ['breathing'], weight: 2, autoSource: { type: 'breathing', refId: 'b3', minMinutes: 3 } },
      { id: 't12', title: 'Чтение книги — 10 страниц / внимание на дыхании', time: '20:00', done: false, pillarTags: ['silence', 'breathing'], weight: 1 },
      { id: 't13', title: 'За 30 мин до сна — без телефона', time: '21:30', done: false, pillarTags: ['silence', 'acceptance'], weight: 1 },
      { id: 't14', title: 'Перед сном — 10 циклов полное дыхание лёжа', time: '21:50', done: false, pillarTags: ['breathing'], weight: 2, autoSource: { type: 'breathing', refId: 'b1', minMinutes: 2 } },
      { id: 't15', title: 'Отход ко сну до 22:00', time: '22:00', done: false, pillarTags: ['acceptance'], weight: 1 },
    ],
  },
]
