...
const tabs: { id: TabId; icon: React.ComponentType<{ size?: number; strokeWidth?: number; style?: React.CSSProperties }> }[] = [
  { id: 'home', icon: Home },
...
export function BottomNav({ activeTab, onTabChange }: BottomNavProps) {
  return (
    <nav
      className="fixed bottom-5 left-1/2 z-50 flex items-center gap-1 px-3 py-2.5"
      style={{
